...
| `nand_model/onfi_sdr_decode_fsm.v` | registered-output hybrid ONFI SDR Decode FSM core | `SIMPLE_ONFI_SDR_decode_fsm.md`, `FSM_RTL_Design_Guide.md`, `nand_adapter_contracts.md` |
...
| `nand_model/onfi_sdr_decode_frontend.v` | Pin Sync + Decode FSM raw handoff frontend wrapper | `Architecture.md`, `SIMPLE_ONFI_SDR_decode_fsm.md`, `nand_adapter_contracts.md` |
